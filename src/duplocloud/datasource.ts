...
export class DataSource {
  ...
  updateServices(tenantId: string, request: ReplicationControllerChangeRequest[]): Observable<null> {
    return this.api.post<null>(`/subscriptions/${tenantId}/ReplictionControllerBulkChange`, request)
  }
