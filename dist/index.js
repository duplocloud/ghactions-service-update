...
const operators_1 = __nccwpck_require__(749);
const axios_observable_1 = __importDefault(__nccwpck_require__(7143));
class DuploHttpClient {
    ...
    doFetch(path, method, body, options) {
        ...
        return axios_observable_1.default.request(init).pipe((0, operators_1.switchMap)(response => {
            var _a;
            if (response.statusText === 'OK' && response.status === 200) {
                const l = (_a = response.headers['content-length']) === null || _a === void 0 ? void 0 : _a.toString();
                if (!l || l !== '0') {
    ...
    runAction() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const tenant = yield (0, rxjs_1.lastValueFrom)(ds.getTenant(tenantInput));
                if (!tenant)
...
const create_observable_1 = __nccwpck_require__(4893);
class Axios {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.Axios = void 0;
__exportStar(__nccwpck_require__(4911), exports);
const axios_1 = __nccwpck_require__(5867);
...
module.exports = __nccwpck_require__(1004)(exports);
...
var animationFrameProvider_1 = __nccwpck_require__(3514);
